...
import static com.processpuzzle.fitnesse.launcher.maven.plugin.fitnesse.mojo.LaunchTest.assertLaunch;
...
public class FitNesseMojoTest {
   ...
   public void testExecuteLaunch() throws MojoExecutionException, MojoFailureException, IOException {
      ...
      assertLaunch( "testExecuteLaunch", null, null, null, null, ((TestFitNesseMojo) helper.mojo).calledWith[0] );
   }
   ...
   public void testExecuteSuite() throws MojoExecutionException, MojoFailureException, IOException {
      ...
      assertExecute();
      assertEquals( 1, ((TestFitNesseMojo) helper.mojo).calledWith.length );
      assertLaunch( "testExecuteSuite", null, "abc", "def", "xyz", ((TestFitNesseMojo) helper.mojo).calledWith[0] );
   }

   @Test
   public void testExecuteTest() throws MojoExecutionException, MojoFailureException, IOException {
      ...
      assertExecute();
      assertEquals( 1, ((TestFitNesseMojo) helper.mojo).calledWith.length );
      assertLaunch( null, "testExecuteTest", "abc", "def", "xyz", ((TestFitNesseMojo) helper.mojo).calledWith[0] );
   }
   ...
   private void assertExecute() throws MojoExecutionException, MojoFailureException, IOException {
      ...
      assertEquals( format( newlines( expected, "" ), new File( this.getClass().getResource( "/dummy.jar" ).getFile() ), helper.mojo.project.getBasedir() ), actual );
   }
