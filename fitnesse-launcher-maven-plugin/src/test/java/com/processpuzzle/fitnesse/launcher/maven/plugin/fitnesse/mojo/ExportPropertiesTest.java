...
public class ExportPropertiesTest {
   ...
   public void setUp() {
      ...
      when( helper.mojo.fitNesseHelper.formatAndAppendClasspathArtifact( any( StringBuilder.class ), eq( helper.fitnesseArtifact ) ) ).then( new Answer<StringBuilder>() {
         @Override
   ...
   public void testExportPropertiesBasedirException() throws MojoExecutionException {
      ...
      assertTrue( helper.logStream.toString().contains(
            String.format( "[ERROR] %njava.lang.NullPointerException%n" + "	at com.processpuzzle.fitnesse.launcher.maven.plugin.fitnesse.mojo.AbstractFitNesseMojo.exportProperties(AbstractFitNesseMojo.java:" ) ) );
   }
