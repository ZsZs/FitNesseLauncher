...
public class ExportPropertiesTest {
   ...
   public void testExportPropertiesBasedirException() throws MojoExecutionException {
      ...
      assertTrue( helper.logStream.toString().contains(
            String.format( "[ERROR] %njava.lang.NullPointerException%n" + "	at com.processpuzzle.maven.plugin.fitnesse.mojo.AbstractFitNesseMojo.exportProperties(AbstractFitNesseMojo.java:" ) ) );
   }
